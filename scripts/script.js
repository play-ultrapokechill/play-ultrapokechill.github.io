...
function openCredits() {
  document.getElementById("tooltipTop").style.display = `none`;
  document.getElementById("tooltipTitle").innerHTML = `Credits`;
  document.getElementById("tooltipMid").style.display = `none`;
  document.getElementById("tooltipBottom").innerHTML = `
    Made by <span onclick="secretFight(areas.missingArea.id)">Duck</span>
    <br><br>
    <strong>UltraPokechill Modded Version</strong><br>
    Mod support and the Workshop system were made for this version with the community in mind, so players can install, share, and create their own mods.
    <br><br>
